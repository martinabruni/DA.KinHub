...
param kinListOpenAiModelDeploymentName = 'gpt-4o-mini'
...
param kinRecipeImage = 'ghcr.io/example/kinhub-kinrecipe:latest'
param kinListImage = 'ghcr.io/example/kinhub-kinlist:latest'
param kinListAudioWorkerImage = 'ghcr.io/example/kinhub-kinlist-audio-worker:latest'
param kinListMigrationImage = 'ghcr.io/example/kinhub-kinlist-migrations:latest'
