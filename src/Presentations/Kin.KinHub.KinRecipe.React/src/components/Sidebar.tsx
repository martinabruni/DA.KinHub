...
const navItems = [
  { to: '/recipe-books', icon: BookOpen, labelKey: 'nav.recipeBooks', badge: undefined },
  { to: '/fridges', icon: Refrigerator, labelKey: 'nav.fridges', badge: undefined },
  { to: '/shopping-lists', icon: ShoppingCart, labelKey: 'nav.shoppingLists', badge: undefined },
