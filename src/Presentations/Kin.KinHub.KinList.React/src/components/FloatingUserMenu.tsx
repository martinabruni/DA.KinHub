import { ArrowRight, Globe, Grid2x2, LogOut, Moon, Sun, User, Users } from 'lucide-react'
        ...
        <DropdownMenuTrigger asChild>
          ...
          >
            ...
            <div className="ml-2 hidden min-w-0 text-left sm:block">
              ...
              <p className="text-xs text-muted-foreground">{user?.email ?? t('recipeHub.memberLabel')}</p>
            </div>
          </Button>
        </DropdownMenuTrigger>
        <DropdownMenuContent
