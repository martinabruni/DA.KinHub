...
- **Documentazione/operazioni**: `.agents/skills/frontend/SKILL.md`, `.agents/skills/frontend/catalog.json`, eventuali esempi skill, `.agents/skills/implementation/*`, guide/help bilingui, change fragment e `AGENTS.md` se le regole di riuso cambiano.
